...
[Qiitaに投稿した記事](https://qiita.com/masamichiueta/items/0074f002d8f1663577a2)と同じです

[GitHub Pages](https://masamichi.me)でいくつか静的なWebページを作成しているのですが、生のcssではなく、sassでcssを作成することにしました。
